...
mod tests {
    ...
    fn test_create_box_request_serialization() {
        ...
        assert_eq!(value["network"]["allow_public_traffic"], true);
    ...
    fn test_create_box_request_from_options() {
        ...
        assert_eq!(
            req.network.as_ref().and_then(|n| n.allow_public_traffic),
            Some(false)
        );
    ...
    fn test_create_box_request_from_options_disabled_network() {
        ...
        assert_eq!(req.network.as_ref().unwrap().allow_public_traffic, None);
    }
