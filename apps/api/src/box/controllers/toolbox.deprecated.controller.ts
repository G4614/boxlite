...
const RUNNER_INFO_CACHE_PREFIX = 'proxy:box-runner-info:'
...
export class ToolboxController {
  ...
  constructor(
    ...
    const commonProxyOptions: Options = {
      router: async (req: RawBodyRequest<IncomingMessage>) => {
        const boxId = req.url.match(/^\/api\/toolbox\/([^\/]+)\/toolbox/)?.[1]
        try {
          const runnerInfo = await this.getRunnerInfo(boxId)
      ...
      pathRewrite: (path) => {
        const boxId = path.match(/^\/api\/toolbox\/([^\/]+)\/toolbox/)?.[1]
        const routePath = path.split(`/api/toolbox/${boxId}/toolbox`)[1]
        const newPath = `/boxes/${boxId}/toolbox${routePath}`
  ...
  private async getRunnerInfo(boxId: string): Promise<RunnerInfo> {
    let runnerInfo: RunnerInfo | null = null
    try {
      const cached: { value: RunnerInfo } = JSON.parse(await this.redis.get(`${RUNNER_INFO_CACHE_PREFIX}${boxId}`))
    ...
    if (!runnerInfo) {
      const runner = await this.toolboxService.getRunner(boxId)
      if (!runner.proxyUrl) {
      ...
      await this.redis.set(
        `${RUNNER_INFO_CACHE_PREFIX}${boxId}`,
  ...
  @Get(':boxId/toolbox/user-home-dir')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/files/bulk-download')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/files/find')
  @ApiOperation({
    summary: '[DEPRECATED] Search for text/pattern in files',
    description: 'Search for text/pattern inside box files',
  ...
  @Post(':boxId/toolbox/files/folder')
  @HttpCode(200)
  ...
  @Post(':boxId/toolbox/files/permissions')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/files/replace')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/git/branches')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/git/branches')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Delete(':boxId/toolbox/git/branches')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/git/checkout')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/process/execute')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/process/session/:sessionId')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/process/session')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/process/session/:sessionId/exec')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Delete(':boxId/toolbox/process/session/:sessionId')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/process/session/:sessionId/command/:commandId')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/process/session/:sessionId/command/:commandId/logs')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/process/pty')
  @HttpCode(201)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/process/pty/:sessionId')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/process/pty/:sessionId/resize')
  @ApiOperation({
  ...
  @Delete(':boxId/toolbox/process/pty/:sessionId')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/lsp/completions')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/lsp/did-close')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/lsp/did-open')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/lsp/document-symbols')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/lsp/start')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
    summary: '[DEPRECATED] Start Lsp server',
    description: 'Start Lsp server process inside box project',
  ...
  @Post(':boxId/toolbox/lsp/stop')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
    summary: '[DEPRECATED] Stop Lsp server',
    description: 'Stop Lsp server process inside box project',
  ...
  @Get(':boxId/toolbox/lsp/workspace-symbols')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/start')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/stop')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/status')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/process/:processName/status')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/process/:processName/restart')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/process/:processName/logs')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/process/:processName/errors')
  @ApiOperation({
  ...
  // Mouse endpoints
  @Get(':boxId/toolbox/computeruse/mouse/position')
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/mouse/move')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/mouse/click')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/mouse/drag')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/mouse/scroll')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  // Keyboard endpoints
  @Post(':boxId/toolbox/computeruse/keyboard/type')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/keyboard/key')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Post(':boxId/toolbox/computeruse/keyboard/hotkey')
  @HttpCode(200)
  @UseInterceptors(ContentTypeInterceptor)
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/screenshot')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/screenshot/region')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/screenshot/compressed')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/screenshot/region/compressed')
  @ApiOperation({
  ...
  // Display endpoints
  @Get(':boxId/toolbox/computeruse/display/info')
  @ApiOperation({
  ...
  @Get(':boxId/toolbox/computeruse/display/windows')
  @ApiOperation({
